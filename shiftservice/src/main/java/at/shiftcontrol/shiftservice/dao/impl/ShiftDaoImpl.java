...
public class ShiftDaoImpl implements ShiftDao {
    ...
    @Override
    public List<Shift> searchShiftsInShiftPlan(long shiftPlanId, String userId, EventScheduleFilterDto filterDto) {
        Specification<Shift> spec = ShiftSpecifications.inShiftPlan(shiftPlanId)
