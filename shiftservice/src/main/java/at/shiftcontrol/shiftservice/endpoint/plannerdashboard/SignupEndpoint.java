...
public class SignupEndpoint {
    ...
    public void acceptRequest(@PathVariable String shiftPlanId, @PathVariable String positionSlotId, String userid) throws ForbiddenException {
    ...
    public void declineRequest(@PathVariable String shiftPlanId, @PathVariable String positionSlotId, String userid) throws ForbiddenException {
