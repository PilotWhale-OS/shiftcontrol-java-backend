...
public class RoleItemEndpoint {
    ...
    public RoleDto getRole(@PathVariable String roleId) throws ForbiddenException {
    ...
    public void deleteRole(@PathVariable String roleId) throws ForbiddenException {
